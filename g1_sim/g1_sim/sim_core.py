...
WORLD_ALIASES = {
    'empty': os.path.join(PKG, 'worlds', 'empty_world.sdf'),
    'g1_free_roam': os.path.join(PKG, 'worlds', 'g1_free_roam.world.sdf'),
    'g1_demo_vel': os.path.join(PKG, 'worlds', 'g1_demo_cmd_vel.world.sdf'),
    'g1_demo_pos': os.path.join(PKG, 'worlds', 'g1_demo_cmd_pos.world.sdf'),
}

ROBOT_ALIASES = {
    'g1_free_roam': os.path.join(PKG, 'models', 'g1_29dof', 'model.sdf'),
    'g1_demo_vel': os.path.join(PKG, 'models', 'g1_demo_cmd_vel', 'model.sdf'),
    'g1_demo_pos': os.path.join(PKG, 'models', 'g1_demo_cmd_pos', 'model.sdf'),
}

BRIDGE_ALIASES = {
    'clock': os.path.join(PKG, 'bridges', 'clock_bridge.yaml'),
    'g1_vel': os.path.join(PKG, 'bridges', 'g1_vel_bridge.yaml'),
    'g1_pos': os.path.join(PKG, 'bridges', 'g1_pos_bridge.yaml'),
}
