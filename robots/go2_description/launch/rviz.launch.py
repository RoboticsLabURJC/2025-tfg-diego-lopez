...
def generate_launch_description():
    description_file = LaunchConfiguration("description_file", default="go2_description.urdf")
    ...
    rviz2_node = Node(
        ...
        name='rviz2',
        output='screen',
        arguments=['-d', PathJoinSubstitution([FindPackageShare("go2_description"), "launch", "check_joint.rviz"])],
    )
